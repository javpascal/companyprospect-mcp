...
Try this configuration with your API UserID in the URL:
```json
{
  "mcpServers": {
    "nummary": {
...
**Connection fails:**
- Make sure the URL is exactly correct, replacing "abcd123xxx" with your userID:
...
1. Initial GET request might have the API UserID in URL
2. But subsequent POST requests for MCP methods don't preserve it
3. The Referer header might not be set consistently

This is why setting the API UserID in Vercel environment variables is the most reliable method for Claude Desktop.
